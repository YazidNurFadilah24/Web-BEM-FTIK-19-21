			...
			<div class="row">
				<div class="col-md-12">
					<div class="wow bounceIn">
						<h2 class="wow bounceIn">Kalender Akedemik</h2>
						<hr>
						<h4>Time Line</h4>
					</div>					
...
<?php
  ...
  echo "
    ...
    $tampil=mysqli_query($koneksi,"SELECT * FROM kalender_akademik ORDER BY bulan");
    $no=1;
    while ($r=mysqli_fetch_array($tampil)){
			 echo "<tr>
			 			<td>$no</td>
						<td>".$r['tanggal']."  ".$bulan[$r['bulan']+1]." ".$r['tahun']."</td>
