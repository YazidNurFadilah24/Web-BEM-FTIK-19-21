...
$carimenu=mysqli_query($koneksi,"select * from submenu where link_sub='?$page_name1'");
...
<i class='fa fa-angle-left pull-right'></i>
	             ...
	             $sub=mysqli_query($koneksi,"SELECT * FROM submenu, menuutama  
                ...
                if ($jml > 0){
                  echo " <ul class='treeview-menu'>";                 
                    ...
                    echo "<li><a href='$w[link_sub]'><i class='fa fa-angle-double-right'></i> $w[nama_sub]</a>";
            			  $sub2 = mysqli_query($koneksi,"SELECT * FROM submenu WHERE id_submain=$w[id_sub] AND id_submain!=0");
               ...
               $jml=mysqli_num_rows($sub);
                ...
                if ($jml > 0){
                  echo " <ul class='treeview-menu'>";                 
	                while($w=mysqli_fetch_array($sub)){
                    echo 
                      "<li><a href='$w[link_sub]'><i class='fa fa-angle-double-right'></i> $w[nama_sub]</a>";
            			  $sub2 = mysqli_query($koneksi,"SELECT * FROM submenu WHERE id_submain=$w[id_sub] AND id_submain!=0");
                    $jml2=mysqli_num_rows($sub2);
                    if ($jml2 > 0){
			         			  echo "<ul class='treeview-menu'>";
